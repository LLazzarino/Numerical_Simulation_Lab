...
public:
  ...
  // Method to generate a random number with a Sin distribution
  double Sin();
  // Method to generate a uniform step T(x|y) of width max to use in metropolis
  double UnifStep(double max);
  // Method to generate a gaussian step T(x|y) of width sigma to use in metropolis
  double GaussStep(double sigma);

...
double vtail, ptail, bin_size, nbins, sd, VolumeShell, deltar;
double walker[m_props];

// averages
double blk_av[m_props], blk_norm, accepted, attempted;
double glob_av[m_props], glob_av2[m_props];
double stima_pot, stima_pres, stima_kin, stima_etot, stima_temp, stima_gofr;
double err_pot, err_pres, err_kin, err_etot, err_temp;
double err_gofr[m_props];
...
double tailCorrection_v, tailCorrection_p;
